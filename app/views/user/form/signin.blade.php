                    ...
                    <div class="sign__content">
                        ...
                        <form action="{{ route('signin') }}" method="post" class="sign__form">
                            ...
                            <div class="sign__group">
                                <input type="text" class="sign__input" name="username" placeholder="Tên đăng nhập">
                            </div>
                            ...
                            <input type="submit" class="sign__btn" name="login" value="Đăng nhập">
                            ...
                            <span class="sign__text"><a href="{{ route('forgot') }}">Quên mật khẩu?</a></span>
                        </form>
