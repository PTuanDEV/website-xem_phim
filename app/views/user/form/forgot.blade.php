            ...
            <div class="row">
                <div class="col-12">
                    <div class="sign__content">
                        ...
                        <!-- authorization form -->
                        <form action="{{ route('forgot') }}" method="post" class="sign__form">
                            ...
                            <div class="sign__group">
                                <input type="email" class="sign__input" value="{{ $success }}" disabled>
                            </div> 
                            @else
                               <div class="sign__group">
                                <input type="email" class="sign__input" name="email" placeholder="Email">
                            </div> 
                            @endif
                            ...
                            @else
                               <div class="sign__group">
                                <input type="submit" class="sign__btn" name="forgot" value="SEND">
                            </div> 
                            @endif
                            ...
                            <span class="sign__text">Bạn chưa có tài khoản? <a href="{{ route('signup') }}">Tạo tài khoản!</a></span>
                        </form>
