                ...
                <div class="col-12">
                    <div class="main__title">
                        ...
                        <div class="main__title-wrap">
                            <form action="{{ route('admin/comment/block/serch') }}" method="post" class="main__title-form">
                            ...
                            <tbody>
                                @foreach ($comments as $value_com)
                                    <tr>
                                        ...
                                        <td >
                                            <a href="{{ route('admin/comment/open/' . $value_com->id_com) }}"
                        ...
                        <ul class="paginator">
                            @if ($page > 1)
                                <li class="paginator__item paginator__item--prev">
                                    <a href="{{ route('admin/comment/block/' . $page - 1) }}"><i
